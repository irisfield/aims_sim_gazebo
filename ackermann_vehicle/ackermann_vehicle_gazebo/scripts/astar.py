...
class AStar:
    ...
    def __init__(self, start_state, RPM1, RPM2, clearance, threshold, step_size, dt, theta_step):
        self.start_pose_pub = rospy.Publisher('/car1/start_pose', PoseStamped,  queue_size=10)
        self.goal_point_pub = rospy.Publisher('/car1/goal_point', PointStamped,  queue_size=10)
        self.current_pose_pub = rospy.Publisher('/car1/current_pose', PoseStamped,  queue_size=10)
        self.visited_poses_pub = rospy.Publisher('/car1/visited_poses', PoseArray,  queue_size=10)
        self.path_pub = rospy.Publisher('/car1/path', Path, queue_size=10)
        ...
        rospy.Subscriber("/car1/initialpose", PoseWithCovarianceStamped, self.callback_start_pose)
        rospy.Subscriber("/car1/move_base_simple/goal", PoseStamped, self.callback_goal_pose)
